...
export const metadata: Metadata = {
  ...
  description:
    "Sunrise Piles Hospital – Best piles treatment in Wakad, Pune. Painless laser surgery for Piles, Fissure & Fistula. NABH accredited. 5000+ patients. No stitches. Same-day discharge. Call +91 9096965217.",
  alternates: {

...
const testimonials = [
  {
    ...
    date: "March 2024",
    rating: 5,
    text: "I was very scared about surgery but Dr. Jadhav explained everything clearly. The laser procedure was done in 45 minutes and I went home the same day. No pain at all! Back to work in 3 days. Highly recommended.",
    initials: "RS",
  ...
  },
  {
    ...
    date: "April 2024",
    rating: 5,
    text: "Grade 3 piles treated successfully. The daycare laser procedure was amazing — no hospital stay required. The nursing staff was very caring. Would definitely recommend to family and friends.",
    initials: "MK",

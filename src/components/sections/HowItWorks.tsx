...
const steps = [
  ...
  },
  {
    ...
    description: "45-minute daycare surgery. Virtually painless, zero stitches.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description: "Rest briefly, then home. Back to normal in 2–3 days with full support.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <RevealOnScroll>
          <SectionHeader
            ...
            highlight="Recovery"
            description="From your first call to going home the same day — here is what to expect."
          />
        </RevealOnScroll>
